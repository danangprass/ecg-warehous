<div class="bg-white">
    <div class="py-4">
        <div class="flex justify-center"> <!-- Center the SVG horizontally -->
            <div class="bg-red-100 p-4 rounded-full text-center">
                <!-- Heroicon name: outline/exclamation -->
                <svg width="64px" height="64px" class="h-20 w-20 text-red-600" stroke="currentColor" fill="none"
